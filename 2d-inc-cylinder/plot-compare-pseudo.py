...
#ax2.semilogy(df3['n'][:15], df3['p'][:15],  label=r'$SDIRK43$')
...
ax2.scatter(df2['n'][14], df2['p'][14], s=100, facecolors='none', edgecolors='C0')
#ax2.scatter(df3['n'][14], df3['p'][14], s=100, facecolors='none', edgecolors='C1')
ax2.scatter(df1['n'][10], df1['p'][10], s=100, facecolors='none', edgecolors='C1')
