...
ax1.plot(df['t'], df['walldt'], label='walldt')
ax1.plot(df['t'], df['walldt_avg'], label='walldt_avg')
...
# Print the location and bins for the PDF
print('loc =', params[1])
print('scale =', params[2])
print('bins =', np.linspace(0.00025, 0.00075, 100).tolist())
